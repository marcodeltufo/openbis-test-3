...
-   [Search](https://openbis.ch/index.php/docs/user-documentation/search/)
    ...
    -   <a
        href="https://openbis.ch/index.php/docs/user-documentation/search/save-and-reuse-searches/"
        aria-current="page">Save and reuse searches
-   [Additional
...
7.  
8.  <a href="https://openbis.ch/index.php/docs/user-documentation/search/"
    itemprop="item">Search
9.  
10. Save and reuse searches
